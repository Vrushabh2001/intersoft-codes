...
def wishMe():
    ...
    if hour >= 0 and hour < 12:
        speak("hello, good morning Ms.Vrushabh")
        print("hello, good morning Ms.Vrushabh")
    elif hour >=12 and hour <=18:
        speak("hello, good afternoon Ms.Vrushabh")
        print("hello, good afternoon Ms.Vrushabh")
    else:
        ...
        if 'wikipedia' in statement:
            ...
            if x["cod"] != "404":
                ...
                print("city not found")
                    ...
                    speak("I WAS BUILT BY Vrushabh")
                    print("I WAS BUILT BY Vrushabh")
